...
#ifndef __FAKE_ANALOG_SENSORS_HPP__
#define __FAKE_ANALOG_SENSORS_HPP__
...
/**
 * @ingroup YarpPlugins
 * \defgroup FakeAnalogSensors
 *
 * @brief Contains roboticslab::FakeAnalogSensors.
 */

/**
 * @ingroup FakeAnalogSensors
 * @brief Implements the YARP_dev ISixAxisForceTorqueSensors, etc.
 * interface class member functions.
 */
class FakeAnalogSensors : public yarp::dev::DeviceDriver, public yarp::dev::ISixAxisForceTorqueSensors
{
public:
...
private:
    ...
    unsigned int            numFtSensors;
    double                  startTime;

    static const int DEFAULT_NUM_FT_SENSORS;
};
